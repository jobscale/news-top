...
- 社会問題を想起させる用語（深刻や理不尽など）であっても、事例の詳細が不明なものはスコアを低くしてください。
- 固有名詞、関係人物、日付、場所が曖昧なものは、たとえ深刻に見えてもスコアは低めにしてください。
- 題材が医療や社会問題であっても、「誰に」「いつ」「どこで」起きたかが不明な場合は具体性が欠けると判断してください。
- 犠牲者や遺族の感情・心情の表明だけに焦点を当てたタイトルはスコアを低くしてください。
- 事件の詳細や新情報がない場合、「悲しみ」「後悔」「驚き」「無念」などの表現に流されず低評価にしてください。
